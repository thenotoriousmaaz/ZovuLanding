    ...
    <section className="mx-auto w-full max-w-[1600px] px-10 py-24">
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div className="flex items-start justify-center">
          <div className="relative h-[560px] w-[640px] overflow-hidden rounded-xl ring-1 ring-black/10">
            <Image
              src="/images/cost.jpg"
        ...
        {/* Right content */}
        <div>
          <h3 className="text-4xl font-bold leading-tight text-neutral-900 md:text-5xl" style={{ fontFamily: "var(--font-libre-baskerville)" }}>
          ...
          <div className="mt-8 rounded-xl border border-neutral-200">
            <Accordion type="single" collapsible className="divide-y rounded-xl bg-white">
              ...
              <AccordionItem value="p-2" className="px-4">
                ...
                <AccordionContent>
                  <p className="pb-4 text-sm text-neutral-600">Cancel any time, data stays yours.</p>
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="p-3" className="px-4">
                ...
                <AccordionContent>
                  <p className="pb-4 text-sm text-neutral-600">Reach out and we’ll onboard you in days—not weeks.</p>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>

          <form className="mt-8 rounded-xl border border-neutral-200 p-4">
            <label className="block text-base font-medium text-neutral-800">Let’s get in contact</label>
            <div className="mt-3 flex h-12 items-center overflow-hidden rounded-lg border border-neutral-300 bg-white">
              <input
                type="email"
                placeholder="your email address"
                className="h-full w-full flex-1 bg-transparent px-3 text-base text-neutral-900 placeholder:text-neutral-500 focus:outline-none"
              />
